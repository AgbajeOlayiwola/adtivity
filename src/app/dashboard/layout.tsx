...
import { mainNavLinks, secondaryNavLinks, groupedNavLinks } from '@/components/layout/navigation-links';
          ...
          <header className="sticky top-0 z-40 flex h-16 items-center justify-between gap-4 border-b bg-background/80 backdrop-blur-sm px-6">
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                <Input type="search" placeholder="Search..." className="pl-9 w-64 bg-card/50 border-border/70 focus:border-primary" />
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center gap-2 px-2 py-1 rounded-full h-auto">
